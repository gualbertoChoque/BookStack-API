...
def test_TC001_Obtener_la_lista_de_libros_visibles(get_url):
    ...
    assert_response_schema(response.json(), "get_list_books_response.json", "schemas_books")
...
def test_TC002_Verificar_error_al_obtener_una_lista_sin_token_en_la_lista_de_libros(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.books.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_TC003_Verificar_error_al_obtener_una_lista_de_libros_con_token_invalido(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.books.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_TC004_Verificar_error_al_obtener_una_lista_de_libros_con_la_URL_incorrecta(get_url):
