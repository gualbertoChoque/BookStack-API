...
def test_TC001_Obtener_un_estante_existente_con_id_valido(get_url, setup_add_shelves, setup_delete_shelves_by_id):
    ...
    assert_response_schema(response.json(), "get_shelves_response_by_code.json", "schemas_shelves")
...
@pytest.mark.regression
@pytest.mark.positive
def test_TC002_Obtener_estante_con_header_valido(get_url, setup_add_shelves, setup_delete_shelves_by_id):
    shelf_id = setup_add_shelves["id"]
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
                                str(shelf_id), StaticDataHeaders.default_header.value)
    log_api_call(method="GET",
                 url=response.url,
                 headers=response.headers,
                 payload=None,
...
@pytest.mark.regression
@pytest.mark.positive
def test_TC003_Obtener_estante_despues_de_creacion(get_url, setup_add_shelves, setup_delete_shelves_by_id):
    id_to_create = setup_add_shelves["id"]
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
                                str(id_to_create), StaticDataHeaders.default_header.value)
...
@pytest.mark.regression
@pytest.mark.positive
def test_TC004_Obtener_estante_con_token_valido(get_url, setup_add_shelves, setup_delete_shelves_by_id):
    id_to_create = setup_add_shelves["id"]
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
                                str(id_to_create), StaticDataHeaders.default_header.value)
...
def test_GCTC005_Verificar_que_se_muestre_error_al_mandar_la_URL_mal_formada(get_url):
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC006_Obtener_un_shelves_con_token_incorrecto(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC007_Obtener_un_shelves_inexistente(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC008_Verificar_que_no_permita_obtener_un_shelves_con_id_vacío(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC009_Verificar_que_no_permita_obtener_un_shelves_con_caracteres_especiales_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0010_Verificar_que_no_permita_obtener_un_shelves_con_letras_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0011_Verificar_que_no_permita_obtener_un_shelves_con_letras_minusculas_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0012_Verificar_que_no_permita_obtener_un_shelves_con_letras_mayusculas_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0013_Verificar_que_no_permita_obtener_un_shelves_con_letras_y_numeros_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0014_Verificar_que_no_permita_obtener_un_shelves_con_un_0_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0015_Verificar_que_no_permita_obtener_un_shelves_con_varios_0_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0016_Verificar_que_no_permita_obtener_un_shelves_con_valor_negativo_en_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0017_Verificar_que_no_permita_obtener_un_shelves_con_espacio_entre_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0018_Verificar_que_no_permita_obtener_un_shelves_con_espacio_delante_el_id(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0019_Verificar_que_sin_header_token_devuelva_error(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0020_Verificar_que_sin_header_devuelva_error(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0021_Verificar_que_se_devuelva_error_405_si_se_usa_método_POST_en_lugar_de_GET(get_url):
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0022_Verificar_que_se_devuelva_error_405_si_se_usa_método_DELETE_en_lugar_de_GET(get_url):
...
@pytest.mark.regression
@pytest.mark.negative
def test_GCTC0023_Obtener_un_shelves_sin_autentificarse(get_url):
    response = request_function(StaticDataVerbs.get.value, get_url, StaticDataModules.shelves.value,
                                StaticDataHeaders.no_token_header.value)
